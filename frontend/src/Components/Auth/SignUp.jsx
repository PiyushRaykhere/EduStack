...
const SignUp = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    confirmPassword: '',
    age: '',
    profilePicture: 'https://chisellabs.com/glossary/wp-content/uploads/2023/05/962b45f9-e2a6-4f59-8f0a-9e1e1a1d1f7f.png',
    agreeToTerms: false
  });
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-lg">
        ...
        <div className="flex justify-center">
          <div className="relative">
            <div className="h-24 w-24 rounded-full overflow-hidden bg-gray-100 border-2 border-blue-500">
              <img 
                src={formData.profilePicture} 
                alt="Profile" 
                className="h-full w-full object-cover"
                onError={(e) => {
                  e.target.src = 'https://chisellabs.com/glossary/wp-content/uploads/2023/05/962b45f9-e2a6-4f59-8f0a-9e1e1a1d1f7f.png';
                }}
              />
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-gray-500">
                Leave empty to use default profile picture
              </p>
            </div>
